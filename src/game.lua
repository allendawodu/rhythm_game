...
function game:enter(previous, ...)
    ...
    track = iTrack():load({1, 5, 9, 33, 37, 41, 65, 69, 73, 97, 101, 105, 129, 133, 137, 141, 145, 149, 153, 157, 158, 159, 160})
    conductor = iConductor():load(love.audio.newSource("dev/milk.ogg", "stream"), 150, 1.6)
    iJudgement():load({1, 5, 9, 33, 37, 41, 65, 69, 73, 97, 101, 105, 129, 133, 137, 141, 145, 149, 153, 157, 158, 159, 160})
